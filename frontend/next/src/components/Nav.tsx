  ...
  return (
    <nav aria-label="Primary" className="sticky top-0 z-40 border-b-2 border-[var(--border)] bg-[var(--surface)]">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <NavLinks user={user} className="md:hidden flex items-center gap-5 overflow-x-auto border-t border-[var(--border)] text-xs font-bold uppercase whitespace-nowrap [&_a]:py-3.5" />
      </div>
    </nav>
  )
}
